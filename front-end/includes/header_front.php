  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="http://localhost:8080/Cosas/blog_api/front-end/img/slides/santorini1.jpg" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="http://localhost:8080/Cosas/blog_api/front-end/img/slides/florencia.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block caja2">
      ...
      <div class="carousel-item">
        <img src="http://localhost:8080/Cosas/blog_api/front-end/img/slides/venecia.jpg" class="d-block w-100" alt="...">
